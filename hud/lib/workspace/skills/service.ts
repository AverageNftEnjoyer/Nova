...
export function validateSkillMarkdown(contentRaw: string, expectedName: string): { normalized: string; errors: string[] } {
  const errors: string[] = []
...
export function buildSkillTemplate(skillName: string, description?: string): string {
...
export function filterInvokableSkills(skills: SkillSummary[]): SkillSummary[] {
