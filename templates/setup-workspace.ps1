...
Write-Info "1) $WorkspaceDir\USER.md"
Write-Info "2) $WorkspaceDir\SOUL.md"
Write-Info "3) $WorkspaceDir\AGENTS.md"
Write-Info "4) $WorkspaceDir\MEMORY.md"
Write-Info "5) $WorkspaceDir\skills\*\SKILL.md"
