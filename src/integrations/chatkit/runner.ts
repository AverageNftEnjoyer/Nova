...
import { resolveChatKitRuntimeConfig, validateChatKitRuntimeConfig } from "./config.js";
import type { ChatKitRunInput, ChatKitRunResult } from "./types.js";
...
export async function runChatKitWorkflow(input: ChatKitRunInput): Promise<ChatKitRunResult> {
  ...
  try {
    sdk = (await dynamicImport("@openai/agents")) as AgentsSdkModule;
  } catch (err) {
