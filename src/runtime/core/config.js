...
// Runtime constants are owned by src/runtime/core/constants.js.
...
import {
  ...
  TOOL_SAFE_BINARIES,
  TOOL_ALLOW_ELEVATED,
  TOOL_ALLOW_DANGEROUS,
  TOOL_ELEVATED_ALLOWLIST,
  TOOL_DANGEROUS_ALLOWLIST,
  TOOL_CAPABILITY_ENFORCE,
  TOOL_CAPABILITY_ALLOWLIST,
  TOOL_CAPABILITY_DENYLIST,
...
export const toolRuntime = createToolRuntime({
  ...
  allowElevatedTools: TOOL_ALLOW_ELEVATED,
  allowDangerousTools: TOOL_ALLOW_DANGEROUS,
  elevatedToolAllowlist: TOOL_ELEVATED_ALLOWLIST.join(","),
  dangerousToolAllowlist: TOOL_DANGEROUS_ALLOWLIST.join(","),
  enforceCapabilities: TOOL_CAPABILITY_ENFORCE,
