...
import { normalizeCoinbaseCommandText } from "../../../../../services/coinbase/command-parser/index.js";
import { executeCoinbaseProviderTool } from "../../../../../services/coinbase/provider-adapter/index.js";
...
export async function executeCoinbaseTool(runtimeTools, availableTools, toolName, input) {
  return executeCoinbaseProviderTool(runtimeTools, availableTools, toolName, input);
}
